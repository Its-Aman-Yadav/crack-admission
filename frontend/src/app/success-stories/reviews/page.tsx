...
export default function ReviewSection() {
  ...
  useEffect(() => {
    const fetchReviews = async () => {
      try {
        const response = await fetch('http://localhost:1337/api/reviews?populate[VideoSection]=*');
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative">
          ...
          <div className="border-t border-b border-blue-300 py-4">
            <p className="text-xl md:text-2xl text-gray-700 italic text-center px-8">The sole reason we are in business is to make life less difficult for our clients

...
<>
    ...
    <div className="bg-blue-50 py-12 px-4">
       <div className="max-w-4xl mx-auto">
         <h1 className="text-4xl md:text-5xl font-bold text-center p-3 text-blue-500 mb-8">Free Consultation</h1>
     ...
     <div className="container mx-auto px-4 py-16 text-center">
        ...
        <p className="text-lg text-gray-600">
          Schedule a FREE PROFILE EVALUATION Call with one of our experts to learn how we can help you.
        </p>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="lg:pl-6 space-y-8">
          <div className="relative">
            ...
            <h2 className="text-3xl font-bold text-gray-900">Get into your Dream B school</h2>
            <p className="mt-2 text-gray-600">Get a free profile evaluation done today</p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <a href="tel:+919701215544" className="text-blue-500 hover:underline">
                      +91-9701215544
                    </a>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">California, USA Winward Way, San Mateo</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <MapPin className="w-5 h-5 text-gray-600 mt-1" />
                  <div>
                    <h3 className="font-medium text-gray-900">India Office</h3>
                    <p className="text-gray-600">New Delhi, India DLF Phase 5, Gurgaon</p>
                  </div>
                </div>
              </div>
            </div>

...
export default function Component() {
  useEffect(() => {
    document.title = "Sample Interview Questions";
  }, []);
  const questions = [
    {
  ...
  return (
    <>
      <Head>
        <title>Sample Interview Questions | CrackAdmission</title>
        <meta
          name="description"
          content="Prepare for your MBA or professional interview with curated sample questions tailored for various roles like Management Consulting, Product Management, Operations, and more. Elevate your confidence with these practical scenarios and expert tips."
        />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta
          name="keywords"
          content="Sample Interview Questions, MBA Interview Questions, Management Consulting Questions, Product Management Questions, Operations Questions, MBA Preparation, Mock Interview Questions, Career Interview Questions"
        />

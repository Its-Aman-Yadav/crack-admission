...
const programs = [
  ...
  {
    title: "Masters in Family Business",
    description:
    ...
    <>
      ...
      <div className="bg-blue-50 py-12 mb-10 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold text-center text-blue-500 mb-8">
            Services
          </h1>
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="container mx-auto px-4 py-8 mt-10">
        ...
        <p className="text-center text-gray-600 mb-20">
          Get focused attention on all aspects of your application including
          essays, resume, LORs, scholarships, and interview prep
        </p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
          {pricingTiers.map((tier, index) => (
            <div
              ...
              className={`flex flex-col border border-gray-200 rounded-lg p-6 shadow-md ${
                tier.popular
                  ? "md:scale-110 shadow-lg z-10 border-blue-500 border-2"
                  : ""
              }`}
            >
              <div className="relative">
                ...
                <div className="text-4xl font-bold mt-2">
                  ...
                  <span className="text-gray-800">{tier.price} </span>
        ...
        <p className="text-center text-gray-600 mt-20 mb-20">
          Disclaimer: Rates are indicative and subject to change based on
          current currency conversion rates and market fluctuations.
        </p>

        {/* Programs Section */}
        <div className="bg-blue-100 p-5 w-full">
          <h2 className="text-2xl font-bold text-gray-800 text-center mt-10 mb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-4">
            ...
            {programs.map((program, index) => (
              <div
                key={index}
                className="bg-white border border-gray-100 rounded-lg shadow-lg p-6 max-w-md mx-auto transition-transform transform hover:scale-105 hover:shadow-xl"
              >
                {" "}
                ...
                {/* Added space for a cleaner look */}
              </div>
            ))}
          </div>
        </div>

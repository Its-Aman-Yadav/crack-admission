        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex font-semibold text-gray-600 space-x-6">
            ...
            <div className="relative group">
              ...
              <div className="absolute hidden group-hover:flex bg-white/95 backdrop-blur-md border border-gray-200 rounded-lg shadow-lg p-6 transition-all duration-300 ease-in-out -left-1/2 top-full pointer-events-auto">
                <div className="flex flex-col space-y-6">
                  <Link href="/success-stories/reviews" className="text-gray-800 hover:text-blue-500 whitespace-nowrap">
                    Reviews
                  </Link>
                </div>
              </div>
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              {openDropdown === 'about' && (
                <div className="pl-4 space-y-2">
                  <Link href="/about-us/ourphilosophy" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    Our Philosophy
                  </Link>
                  <Link href="/about-us/your-team" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    Your Team
                  </Link>
                  <Link href="/about-us/success-recipe" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    Success Recipe
                  </Link>
                </div>
              )}
              ...
              {openDropdown === 'services' && (
                <div className="pl-4 space-y-2">
                  <Link href="/services/comprehensive-consulting" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    Comprehensive Consulting
                  </Link>
                  <Link href="/services/consulting/mockinterviews" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    Mock Interviews
                  </Link>
                  <Link href="/services/consulting/essay-editing" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    Essay Editing
                  </Link>
                  <Link href="/services/consulting/resume" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    Resume
                  </Link>
                  <Link href="/services/consulting/recommendation" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    Recommendation Letter
                  </Link>
                  <Link href="/services/consulting/scholarships" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    Scholarship Essay
                  </Link>
                  <Link href="/services/consulting/re-application" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    Re-Application
                  </Link>
                  <Link href="/services/consulting/essay-writing" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    Essay Writing
                  </Link>
                  <Link href="/services/consulting/dinganalysis" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    Ding Analysis
                  </Link>
                  <Link href="/services/consulting/profile-evaluation" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    Profile Evaluation
                  </Link>
                  <Link href="/services/consulting/profilepresentations" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    Profile Presentations
                  </Link>
                </div>
              )}
              ...
              {openDropdown === 'success' && (
                <div className="pl-4 space-y-2">
                  <Link href="/success-stories/reviews" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    Reviews
                  </Link>
                </div>
              )}
              ...
              {openDropdown === 'resources' && (
                <div className="pl-4 space-y-2">
                  <Link href="/mbaresources/sample-essays" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    Sample Essays
                  </Link>
                  <Link href="/mbaresources/samplescholarshipessays" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    Sample Scholarship Essays
                  </Link>
                  <Link href="/mbaresources/samplecvs" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    Sample CVs
                  </Link>
                  <Link href="/mbaresources/samplelors" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    Sample LORs
                  </Link>
                  <Link href="/mbaresources/sampleprofilepresentations" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    Sample Profile Presentations
                  </Link>
                  <Link href="/mbaresources/kirainterviewguide" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    KIRA Interview Guide
                  </Link>
                  <Link href="/mbaresources/sampleinterviewquestions" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    Sample Interview Questions
                  </Link>
                  <Link href="/mbaresources/essayanalysis" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    Essay Analysis
                  </Link>
                  <Link href="/mbaresources/schoolguide" className="block px-3 py-2 rounded-md text-base font-medium text-black">
                    School Guide
                  </Link>
                </div>
              )}
              <Link href="/blogs" className={`text-black block px-3 py-2 rounded-md text-base font-medium`}>
                Blogs
              </Link>
              <Link
                href="/contact-us"
